...
describe("BinarySearchTree", function () {
    ...
    describe("insertAll(array) method", function () {
        it("adds all array of elements to the bst (left or right)", function () {
            bst.insertAll([0,9]);
            assert.equal(bst.root.left.left.left.value, 0);
            assert.equal(bst.root.right.right.right.value, 9);
        });
    ...
    describe("readIntoArray() method", function () {
        it("reads all values of bst using in-order-traversal and put in an array", function () {
            assert.equal(bst.readIntoArray().toString(), "1,3,4,5,6,7,8");
        });
    });
